...
s (s > 0). An der Basisseite des Dreiecks mit der Länge $2 \cdot r$ ist ein Halbkreis bündig angelagert. Der Winkel $\alpha$ zwischen den beiden Schenkeln des Dreiecks kann im Bereich zwischen 0\degree~und 180\degree ~verändert werden. Je nach Größe von $\alpha$ ändert sich auch die grau hinterlegte Fläche (siehe Abbildung \ref{fig:aufgabenstellung}), die sich aus der Summe von Dreiecksfläche und Halbkreisfläche ergibt.
