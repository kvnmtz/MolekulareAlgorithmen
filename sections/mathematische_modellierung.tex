...
Folglich ergeben sich der Radius des angelagerten Halbkreises und die Höhe des Dreiecks zu
...
Durch Einsetzen von \eqref{eq:radius_und_hoehe} folgt
...
Mit \eqref{eq:dreiecksflaeche} folgt
...
\eqref{eq:alpha_max} in \eqref{eq:gesamtflaeche} eingesetzt. Sei dazu
